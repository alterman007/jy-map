...
class Area extends React.Component {
  ...
  handleClick(ev) {
    this.setState({
      ...
      clickAreaPosition: ev.sourceTarget.feature.properties.center
    }, () => {
    ...
    return (
      <>
        ...
        <GeoJSON
          ...
          style={(f) => {
            return {
              color: f.properties.name === clickAreaName ? 'red' : 'transparent',
              weight: 4,
              fillOpacity: f.properties.name === clickAreaName ? 0.2 : 0,
              fillColor: 'yellow',
            }
          }}
